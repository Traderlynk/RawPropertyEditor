				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><img src="images/file1.png"
							...
							+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(username))%>')"></td>
						<%
							/*
				...
				<tfoot>
					<tr>
						<td colspan="2"><input type="submit" name="jsdosave"
							value="Save Property"
							onclick="dosave('<%=StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(propname2)) + "','" + StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(propvalue2))%>')"></td>
					</tr>
				</tfoot>
			</table>
		</div>
